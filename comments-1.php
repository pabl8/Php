/* En public_html/wp-content/themes/wyzi-business-finder/templates/comments/comments-1.php */
...
<div id="comments" class="comment-list margin-bottom-50 margin-top-50 fix">
	...
	<h5 class="comments-title">
		<?php printf( _n( 'Opiniones sobre &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'wyzi-business-finder' ), number_format_i18n( get_comments_number() ), esc_html( get_the_title() ) ); ?>
	</h5>
...
<div id="comment-form" class="comment-form-area margin-top-50 fix">
		...
		$comment_args = array(
			...
			'comment_field' => '<div class="input-box comment-form-message"><label for="comment">' . esc_html__( 'Tu Opinión:', 'wyzi-business-finder' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></div>',
			'comment_notes_after' => '<button type="submit" class="wyz-button wyz-secondary-color icon">' . esc_html__( 'Publicar', 'wyzi-business-finder' ) . ' <i class="fa fa-angle-right"></i></button>',
			); ?>
